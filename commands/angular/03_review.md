...
2. Spawn 3 parallel agents (Angular, Quality, Simplicity)
3. Each agent:
...
✅ **Use --team:**
- Critical feature with ComponentStore
- Complex state/effect patterns
- Code requiring architecture review
