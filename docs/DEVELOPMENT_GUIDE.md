...
| **M** | 3-10 파일 | `/explore` → `01-plan` → `02-implement` → `/simplify` → `03-review` → `/verify` → `/tech-debt` → `/ship` |
...
| Angular 새 기능 | `/explore` → `/angular-01-plan` → `02` → `/simplify` → `03` → `04` → `05` → `/verify` → `/tech-debt` → `/ship` |
| React 새 기능 | `/explore` → `/react-01-plan` → `02` → `/simplify` → `03` → `04` → `05` → `/verify` → `/tech-debt` → `/ship` |
| Kotlin 새 기능 | `/explore` → `/kotlin-01-plan` → `02` → `/simplify` → `03` → `04` → `05` → `/verify` → `/tech-debt` → `/ship` |
| Swift 새 기능 | `/explore` → `/swift-01-plan` → `02` → `/simplify` → `03` → `04` → `05` → `/verify` → `/tech-debt` → `/ship` |
| Node.js 새 기능 | `/explore` → `/nodejs-01-plan` → `02` → `/simplify` → `03` → `04` → `05` → `/verify` → `/tech-debt` → `/ship` |
| TypeScript 유틸리티 | `/ts-01-plan` → `02` → `/simplify` → `03` → `/verify` → `/ship` |
